...
{
    public partial class RandevuALt_Cuma_2__ : Form
    {
        public RandevuALt_Cuma_2__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuALt_Cuma_2___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }

        private void RandevuALt_Cuma_2___Load(object sender, EventArgs e)
        {
