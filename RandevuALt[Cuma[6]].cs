...
{
    public partial class RandevuALt_Cuma_6__ : Form
    {
        public RandevuALt_Cuma_6__()
        {
            InitializeComponent();
        }
        SqlConnection randevuBase = dataBase.baglan();
        private void RandevuALt_Cuma_6___Load(object sender, EventArgs e)
        {
        ...
        private void RandevuALt_Cuma_6___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }
    }
