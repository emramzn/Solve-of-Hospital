...
{
    public partial class RandevuAlt_Carsmb_7__ : Form
    {
        public RandevuAlt_Carsmb_7__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuAlt_Carsmb_7___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }

        private void RandevuAlt_Carsmb_7___Load(object sender, EventArgs e)
        {
