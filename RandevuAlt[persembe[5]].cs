...
{
    public partial class RandevuAlt_persembe_5__ : Form
    {
        public RandevuAlt_persembe_5__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuAlt_persembe_5___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }

        private void RandevuAlt_persembe_5___Load(object sender, EventArgs e)
        {
