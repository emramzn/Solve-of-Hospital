...
{
    public partial class RandevuAlt_persembe_7__ : Form
    {
        public RandevuAlt_persembe_7__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuAlt_persembe_7___Load(object sender, EventArgs e)
        {

        }

        private void RandevuAlt_persembe_7___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }
    }
