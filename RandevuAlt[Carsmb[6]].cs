...
{
    public partial class RandevuAlt_Carsmb_6__ : Form
    {
        public RandevuAlt_Carsmb_6__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuAlt_Carsmb_6___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }

        private void RandevuAlt_Carsmb_6___Load(object sender, EventArgs e)
        {
