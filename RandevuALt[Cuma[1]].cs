...
{
    public partial class RandevuALt_Cuma_1__ : Form
    {
        public RandevuALt_Cuma_1__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuALt_Cuma_1___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }

        private void RandevuALt_Cuma_1___Load(object sender, EventArgs e)
        {
