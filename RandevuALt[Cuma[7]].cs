...
{
    public partial class RandevuALt_Cuma_7__ : Form
    {
        public RandevuALt_Cuma_7__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuALt_Cuma_7___Load(object sender, EventArgs e)
        {

        }

        private void RandevuALt_Cuma_7___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }
    }
