...
{
    public partial class RandevuAlt_Sali_4__ : Form
    {
        public RandevuAlt_Sali_4__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuAlt_Sali_4___Load(object sender, EventArgs e)
        {

        }

        private void RandevuAlt_Sali_4___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }
