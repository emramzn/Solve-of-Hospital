...
{
    public partial class RandevuAlt_Sali_7__ : Form
    {
        public RandevuAlt_Sali_7__()
        {
            InitializeComponent();
        }
        SqlConnection randevuBase = dataBase.baglan();
        private void RandevuAlt_Sali_7___Load(object sender, EventArgs e)
        {
        ...
        private void RandevuAlt_Sali_7___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }
    }
