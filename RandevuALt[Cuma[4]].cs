...
{
    public partial class RandevuALt_Cuma_4__ : Form
    {
        public RandevuALt_Cuma_4__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuALt_Cuma_4___Load(object sender, EventArgs e)
        {

        }

        private void RandevuALt_Cuma_4___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }
    }
