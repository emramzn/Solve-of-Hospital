...
{
    public partial class RandevuAlt_persembe_4__ : Form
    {
        public RandevuAlt_persembe_4__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuAlt_persembe_4___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }

        private void RandevuAlt_persembe_4___Load(object sender, EventArgs e)
        {
