...
{
    public partial class RandevuAlt_persembe_2__ : Form
    {
        public RandevuAlt_persembe_2__()
        {
            InitializeComponent();
        }
        SqlConnection randevuBase = dataBase.baglan();
        private void RandevuAlt_persembe_2___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        ...
        private void RandevuAlt_persembe_2___Load(object sender, EventArgs e)
        {
