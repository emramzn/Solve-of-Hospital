...
{
    public partial class RandevuAlt_Sali_2__ : Form
    {
        public RandevuAlt_Sali_2__()
        {
            InitializeComponent();
        }
        SqlConnection randevuBase = dataBase.baglan();
        private void RandevuAlt_Sali_2___Load(object sender, EventArgs e)
        {
        ...
        private void RandevuAlt_Sali_2___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }
    }
