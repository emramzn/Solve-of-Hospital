...
{
    public partial class RandevuAlt_persembe_1__ : Form
    {
        public RandevuAlt_persembe_1__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuAlt_persembe_1___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }
    }
