...
{
    public partial class RandevuAlt_Sali_6__ : Form
    {
        public RandevuAlt_Sali_6__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuAlt_Sali_6___Load(object sender, EventArgs e)
        {

        }

        private void RandevuAlt_Sali_6___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }
    }
