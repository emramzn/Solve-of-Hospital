...
{
    public partial class RandevuAlt_persembe_6__ : Form
    {
        public RandevuAlt_persembe_6__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuAlt_persembe_6___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }

        private void RandevuAlt_persembe_6___Load(object sender, EventArgs e)
        {
