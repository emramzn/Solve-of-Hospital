...
{
    public partial class RandevuAlt_Carsmb_1__ : Form
    {
        public RandevuAlt_Carsmb_1__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuAlt_Carsmb_1___Load(object sender, EventArgs e)
        {
            MessageBox.Show(label9.Text);
        }

        private void RandevuAlt_Carsmb_1___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }
