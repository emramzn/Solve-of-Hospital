...
{
    public partial class RandevuAlt_pzrts_5__ : Form
    {
        public RandevuAlt_pzrts_5__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuAlt_pzrts_5___Load(object sender, EventArgs e)
        {

        }

        private void RandevuAlt_pzrts_5___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }
