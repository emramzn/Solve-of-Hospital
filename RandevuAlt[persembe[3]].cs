...
{
    public partial class RandevuAlt_persembe_3__ : Form
    {
        public RandevuAlt_persembe_3__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuAlt_persembe_3___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }

        private void RandevuAlt_persembe_3___Load(object sender, EventArgs e)
        {
