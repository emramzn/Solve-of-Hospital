...
{
    public partial class RandevuAlt_Carsmb_4__ : Form
    {
        public RandevuAlt_Carsmb_4__()
        {
            InitializeComponent();
        }
        ...
        private void RandevuAlt_Carsmb_4___FormClosed(object sender, FormClosedEventArgs e)
        {
            randevuBase.Close();
        }

        private void RandevuAlt_Carsmb_4___Load(object sender, EventArgs e)
        {
